...
namespace CCT.Common.Web
{
    public class HttpUtility
    {
        ...
        public static string HttpPost(string uri, string apiname, string data)
        {
            try
            {
        ...
        public static string HttpECTPost(string uri, string apiname, string data)
        {
            try
            {
        ...
        public  static string HttpECTFormPost(string uri, string apiname, Dictionary<string, string> parameters)
        {
            try
            {
        ...
        public static string HttpPut(string uri, string apiname, string data)
        {
            string requesturi = string.Format("{0}{1}", uri, apiname);
        ...
        public static string HttpsPost(string uri, string apiname, string data)
        {
            try
            {
                string requesturi = string.Format("{0}{1}", uri, apiname);
