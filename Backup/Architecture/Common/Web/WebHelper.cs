...
namespace CCT.Common.Web
{
	...
	public static class WebHelper
	{
		...
		{
            page.ClientScript.RegisterStartupScript(page.ClientScript.GetType(), Guid.NewGuid().ToString().Trim(), "<script language='javascript'>window.location.href = window.location.href;</script>");
		}
		...
		{
            page.ClientScript.RegisterStartupScript(page.ClientScript.GetType(), Guid.NewGuid().ToString().Trim(), "<script language='javascript'>window.returnValue=0;</script>");
		}
		...
		public static void RefreshParent(Page page)
		{
            ...
            page.ClientScript.RegisterStartupScript(page.ClientScript.GetType(), Guid.NewGuid().ToString().Trim(), "<script language='javascript'>opener=null;window.returnValue=0;window.close();</script>");
		}
		...
		{
            page.ClientScript.RegisterStartupScript(page.ClientScript.GetType(), Guid.NewGuid().ToString().Trim(), "<script language='javascript'>window.location.href='" + location + "'</script>");
		}
		...
		{
            page.ClientScript.RegisterStartupScript(page.ClientScript.GetType(), Guid.NewGuid().ToString().Trim(), "<script language='javascript'>alert('" 
		...
		public static void ShowMessageAndCloseDivDialog(Page page, string message)
		{
            ...
            page.ClientScript.RegisterClientScriptBlock(page.ClientScript.GetType(), Guid.NewGuid().ToString(), String.Format("<script language='javascript'>alert('{0}');CloseDivDialog();</script>", TextHelper.FormatScript(message)));			
		}
		...
		{
			// 与 ShowDivDialog(url, dialogWidth, dialogHeight) 函数联合使用
            page.ClientScript.RegisterClientScriptBlock(page.ClientScript.GetType(), Guid.NewGuid().ToString(), String.Format("<script language='javascript'>CloseDivDialog();parent.location.href='{0}'</script>", TextHelper.FormatScript(location)));
		}
		...
		{
			// 与 ShowDivDialog(url, dialogWidth, dialogHeight) 函数联合使用
            page.ClientScript.RegisterClientScriptBlock(page.ClientScript.GetType(), Guid.NewGuid().ToString(), "<script language='javascript'>CloseDivDialog();parent.location.href=parent.location.href</script>");
		}

		public static void CloseDialogAndRefresh(Page page)
		{
            page.ClientScript.RegisterClientScriptBlock(page.ClientScript.GetType(), Guid.NewGuid().ToString(), "<script language='javascript'>window.parent.$.akModalRemove();parent.location.href=parent.location.href;</script>");
		}
		public static void CloseDialogAndRedirect(Page page, string location)
		{            
            page.ClientScript.RegisterClientScriptBlock(page.ClientScript.GetType(), Guid.NewGuid().ToString(), String.Format("<script language='javascript'>window.parent.$.akModalHideAndRedirect('{0}');</script>", location));
		}
