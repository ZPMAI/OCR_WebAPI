...
namespace OCR.DAL
{
    ...
    {
        private static string CONN_STRING1 = "Server=172.16.1.66;Port=5432;User Id=ocr_view;Password=ocr_view;Database=ivms_port;";
        private static string CONN_STRING2 = "Server=172.16.1.66;Port=5432;User Id=ocr_view;Password=ocr_view;Database=cms_db;";
